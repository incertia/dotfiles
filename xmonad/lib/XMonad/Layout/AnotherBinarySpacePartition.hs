...
-- changed module name to avoid conflicting with xmonad-contrib
module XMonad.Layout.AnotherBinarySpacePartition (
  -- * Usage
  -- $usage
    emptyBSP
  , Rotate(..)
...
-- change to 0.005 because i want to be precise
resizeDiff :: Rational
resizeDiff = 0.005
